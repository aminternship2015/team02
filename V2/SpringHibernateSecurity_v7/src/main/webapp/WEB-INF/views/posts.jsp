					...
					<div class="sidebar blog-sidebar">
						<div class="sidebar-item  recent">
							<a href="blogdetails.html"><img
								src="resources/images/blog/masonary/1.jpg"
						...
						<div class="sidebar-item categories">
							...
							<ul class="nav navbar-stacked">
								<li><a href="#">Tweets<span class="pull-right">(1)</span></a></li>
					...
					<form:form action="savePost" method="post">
						<div class="form-group">
							<textarea path="postText" id="postText" width="100%"
								...
								class="form-control" rows="2" placeholder="What's happening?"></textarea>
						</div>
						 
						<div class="form-group">
							<input type="submit" name="submit" class="btn btn-submit" value="Tweet">
						</div>
						</form:form> 
								...
								<div class="col-md-12 col-sm-12">
									<div class="single-blog two-column">
										...
										<div class="post-content overflow">
											...
											<p><c:out value="${post.postText}"></c:out></p>
											<a href="#" class="read-more"><c:out value="${post.createdAt }"></c:out></a>
